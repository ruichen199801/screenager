package com.ruichen.screenager.recommendation;

import com.ruichen.screenager.db.MySQLConnection;
import com.ruichen.screenager.db.MySQLException;
import com.ruichen.screenager.entity.Game;
import com.ruichen.screenager.entity.Item;
import com.ruichen.screenager.entity.ItemType;
import com.ruichen.screenager.external.TwitchClient;
import com.ruichen.screenager.external.TwitchException;
...
public class ItemRecommender {
    private static final int DEFAULT_GAME_LIMIT = 3; // maximum number of recommended games
    private static final int DEFAULT_PER_GAME_RECOMMENDATION_LIMIT = 10; // maximum number of items per game
    private static final int DEFAULT_TOTAL_RECOMMENDATION_LIMIT = 20; // maximum number of items (e.g. videos/clips)

    // When the user is not logged in: recommend by top games
